...
namespace Lab02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Player 1 Level: {p1level} ");
            Console.WriteLine($"HP: {MaxHp}");
            Console.WriteLine($"Player 1 walk speed: {p1walkspeed}");
            Console.WriteLine($"Player 1 run speed: {p1runspeed}");
            Console.WriteLine();
            Console.WriteLine($"Player 2 Name: {p2name}");
            Console.WriteLine($"Player 2 Rank: {p2rank}");
            Console.WriteLine($"Player 2 Level: {p2level} ");
            Console.WriteLine($"HP: {MaxHp}");
            ...
            Console.WriteLine($"Player 3 Level: {p3level} ");
            Console.WriteLine($"HP: {MaxHp}");
            ...
            Console.WriteLine($"Player 4 Level: {p4level} ");
            Console.WriteLine($"HP: {MaxHp}");
